...
def buscar_link_filme(titulo):
    try:
        # Nova URL de pesquisa com o título do filme
        url_pesquisa = f"https://www.assistir.biz/busca?q={titulo}"
        headers = {
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"
        }
        
        # Faz a requisição de pesquisa no site
        ...
        # Procurar o primeiro link de filme na página de resultados
        link_pagina_filme = None
        for link in soup.find_all('a', href=True):
            if "/filme/" in link['href']:  # Ajuste na busca pelo link do filme
